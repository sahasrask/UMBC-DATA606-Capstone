...
# Load the pre-trained model (ensure you have the model saved as a .h5 file)
model = load_model('nmt_model.weights.h5')

# Tokenizer and other dependencies for processing
# These should be adjusted based on your dataset and tokenizer
with open('test_data.pkl', 'rb') as f:
    sanskrit_tokenizer = pickle.load(f)
with open('train_data.pkl', 'rb') as f:
    english_tokenizer = pickle.load(f)

# Define maximum input length for the translation
max_input_length = 50
...
if st.button("Translate"):
    if sanskrit_input.strip() == "":
        ...
        # Translate the input Sanskrit text to English
